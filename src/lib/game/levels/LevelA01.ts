...
export class LevelA01 extends Level {
  ...
  constructor() {
    ...
    this.playbook.actionsPerTick.set(10, ['exclaim-excitement', 'plunge']);
    this.playbook.actionsPerTick.set(50, ['exclaim-determination']);
    this.playbook.actionsPerTick.set(100, ['l-flipper']);
    this.playbook.actionsPerTick.set(110, ['r-flipper']);
    this.playbook.actionsPerTick.set(200, ['l-flipper']);
    this.playbook.actionsPerTick.set(210, ['r-flipper']);
